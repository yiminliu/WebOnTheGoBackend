...
public class Recipient {
  ...
  public void setFirstName(String idx) {
    mFirstName = idx;
  }

  public void setLastName(String idx) {
    mLastName = idx;
  }

  public void setContactPhone(String idx) {
    mContactPhone = idx;
  }

  public void setEmailAddress(String idx) {
    mEmailAddress = idx;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof Recipient) {
      ...
      if (tempRecipient.getContactPhone().equals(getContactPhone()) && tempRecipient.getEmailAddress().equals(getEmailAddress())
          && tempRecipient.getFirstName().equals(getFirstName()) && tempRecipient.getLastName().equals(getLastName())) {
        return true;
      }
    }
